...
class LC_Page_Admin_Basis extends LC_Page_Admin_Ex
{
    ...
    public function action()
    {
        ...
        switch ($this->getMode()) {
            ...
            case 'complete':
                ...
                $this->tpl_onload .= "window.alert('HYP基本情報の登録が完了しました。');";
            // breakはつけない
            default:
    ...
    public function lfInitParam(&$objFormParam, $post)
    {
        ...
        // メールチェック
        $objFormParam->addParam('求人注文受付メールアドレス', 'email01', null, 'a', array('EXIST_CHECK', 'EMAIL_CHECK', 'EMAIL_CHAR_CHECK'));
        ...
        $objFormParam->addParam('為替相場', 'exchange_rate', PRICE_LEN, 'n', array('EXIST_CHECK', 'NUM_CHECK', 'MAX_LENGTH_CHECK'));

        $objFormParam->addParam('取扱求人', 'good_traded', LLTEXT_LEN, '', array('MAX_LENGTH_CHECK'));
