...
__EOS__;
        ...
        foreach ($arrNewOrder as $key => $val) {
            ...
            $arrNewOrder[$key]['category_name'] = $this->getCateName($arrCateId, $arrCate);
            //get employment status to show
            $arrNewOrder[$key]['employment_status'] = $arrayEmpStatus[$productData[0]['employment_status']];
            //get customer name to show
            $arrNewOrder[$key]['customer_name'] = $customerName[0]['name01'].' '.$customerName[0]['name02'];
            //get job name to show
            $arrNewOrder[$key]['job_name'] = $productData[0]['name'];
