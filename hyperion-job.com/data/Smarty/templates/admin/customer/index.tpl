...
<!--
    ...
    function fnDownloadResume(customer_id) {
        document.form1.mode.value = "downloadResume"
        document.form1['edit_customer_id'].value = customer_id;
        document.form1.submit();
        return false;
    }
    function fnDownloadPdf(customer_id) {
        document.form1.mode.value = "downloadCvPdf"
        document.form1['edit_customer_id'].value = customer_id;
        document.form1.submit();
        return false;
    }
        ...
        <form name="form1" id="form1" method="post" action="?">
            ...
            <table class="list" id="customer-search-result">
                ...
                <tr>
                    ...
                    <th rowspan="2">編集</th>
                    <th rowspan="2">削除</th>
                    <th rowspan="2">履歴書<br>（個人）</th>
                    <th rowspan="2">職務履歴書<br>（個人）</th>
                    <th rowspan="2">履歴書<br>（HYP用）</th>
                </tr>
                <tr>
                    <th>現住所</th>
                    <th>メールアドレス</th>
                ...
                <!--{foreach from=$arrData item=row}-->
                    <tr>
                        ...
                        <td class="center"><!--{$row.customer_id|h}--></td>
                        ...
                        <!--{/if}-->
                        <!-- check resume file is exist -->
                        <!--{if $row.existsResume|h == true}-->
                        <td class="center" rowspan="2"><a href="#" onclick="return fnDownloadResume('<!--{$row.customer_id|h}-->');">ダウンロード</a></td>
                        <!--{else}-->
                        <td class="center" rowspan="2">なし</td>
                        <!--{/if}-->
                        <td class="center" rowspan="2"><a href="#" onclick="return fnDownloadPdf('<!--{$row.customer_id|h}-->');">ダウンロード</a></td>
                    </tr>
                    <tr>
                        <td class="center"><!--{$row.current_address|h}--></td>
