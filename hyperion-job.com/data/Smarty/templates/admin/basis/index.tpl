...
<form name="form1" id="form1" method="post" action="?">
    ...
    <div id="basis" class="contents-main">
        ...
        <table summary="基本情報" id="basis-index-basis">
            ...
            <tr>
                <th>HYP所在地<span class="attention"> *</span></th>
                <td>
                    <p>
        ...
        <table id="basis-index-func">
            ...
            <tr>
                ...
                <td>
                    ...
                    1ドル ＝ <input type="text" name="exchange_rate" value="<!--{$arrForm.exchange_rate|h}-->" maxlength="<!--{$smarty.const.PRICE_LEN}-->" size="10" class="box10" style="<!--{if $arrErr.exchange_rate != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->" />円
