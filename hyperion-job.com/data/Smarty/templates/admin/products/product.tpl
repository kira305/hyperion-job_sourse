    ...
    <table class="form">
        ...
        <tr>
            ...
            <td>
                ...
                <img src="<!--{$arrForm.arrFile[$key].base64_image}-->" alt="<!--{$arrForm.name|h}-->" />　<a href="" onclick="eccube.setModeAndSubmit('delete_image', 'image_key', '<!--{$key}-->'); return false;">[画像の取り消し]</a><br />
                <!--{/if}-->
