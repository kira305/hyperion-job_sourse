...
<table>
    ...
    <tr>
        ...
        <td>
            ...
            Ngày <!--{$arrForm.graduation_day|h}--> Tháng <!--{$arrForm.graduation_month|h}--> Năm <!--{$arrForm.graduation_year|h}-->
            <!--{else}-->
            --
            <!--{/if}-->
        </td>
...
<table>
    ...
    <tr>
        ...
        <td><!--{if strlen($arrForm.current_salary) >= 1}--><!--{$arrForm.current_salary|h}--> Vạn Yên<!--{/if}--></td>
    </tr>
    <tr>
        <th>Mức lương mong muốn</th>
        <td><!--{if strlen($arrForm.desired_salary) >= 1}--><!--{$arrForm.desired_salary|h}--> Vạn Yên<!--{/if}--></td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td>JLPT：<!--{$arrJLPT[$arrForm.jp_level]|h}--><br />Khác：<!--{$arrForm.jp_other|h|default:"Không có"}--></td>
    </tr>
    <tr>
        <th>Trình độ Tiếng Anh</th>
        <td>TOEIC：<!--{$arrForm.toeic|h}--><br />IELTS：<!--{$arrForm.ielts|h}--><br />Khác：<!--{$arrForm.eng_other|h|default:"Không có"}--></td>
    </tr>
    <tr>
        <th>Trình độ Ngoại ngữ khác</th>
        <td><!--{$arrForm.other_language|h|nl2br|default:"Chưa đăng ký"}--></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <th>Chứng chỉ</th>
        <td><!--{$arrForm.qualification|h|nl2br|default:"Chưa đăng ký"}--></td>
    </tr>
    <tr>
        <th>Kỹ năng</th>
        <td><!--{$arrForm.skill|h|nl2br|default:"Chưa đăng ký"}--></td>
    </tr>
    <tr>
        <th>PR bản thân</th>
        <td><!--{$arrForm.self_pr|h|nl2br|default:"Chưa đăng ký"}--></td>
    </tr>
</table>
<!--{if $arrForm.work_experience == 1}-->
    ...
    <table id="career_list" style="table-layout: fixed;">
        ...
        <tr>
            <td>
                <!--{if strlen($arrForm.start_year[$index]) > 0 && strlen($arrForm.start_month[$index]) > 0}--><!--{$arrForm.start_month[$index]|h}-->/<!--{$arrForm.start_year[$index]|h}--><!--{else}-->--<!--{/if}--> 
                <br><br>~<br><br>
                <!--{if strlen($arrForm.end_year[$index]) > 0 && strlen($arrForm.end_month[$index]) > 0}--><!--{$arrForm.end_month[$index]|h}-->/<!--{$arrForm.end_year[$index]|h}--><!--{else}-->--<!--{/if}-->
            </td>
            <td><!--{$arrForm.working_year[$index]|h}--></td>
            <td style="vertical-align:top;overflow-wrap:break-word; width:220px;">
                <label style="background-color:#f2f2f2; width:100%">Tên Công ty</label><br>
                <!--{$arrForm.working_company_name[$index]|h}--><br><br><br>
                <label style="background-color:#f2f2f2; width:100%">Địa chỉ</label><br>
                <!--{$arrForm.company_addr[$index]|h}-->
            </td>
            <td style="vertical-align:top;overflow-wrap:break-word;">
                <label style="background-color:#f2f2f2; width:100%">Số lượng nhân viên</label><br>
                <!--{$arrForm.working_member_num[$index]|h}--><br>
                <label style="background-color:#f2f2f2; width:100%">Hình thức hợp đồng</label><br>
                <!--{$arrForm.working_status[$index]|h}--><br>
                <label style="background-color:#f2f2f2; width:100%">Bộ phận/Chức vụ</label><br>
                <!--{$arrForm.working_position[$index]|h}--><br>
                <label style="background-color:#f2f2f2; width:100%">Nghiệp vụ</label><br>
                <!--{$arrForm.working_type[$index]|h}--><br>
                <label style="background-color:#f2f2f2; width:100%">Công việc đảm nhận</label><br>
