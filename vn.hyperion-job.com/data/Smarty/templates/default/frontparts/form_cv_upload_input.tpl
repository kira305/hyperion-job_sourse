...
<table>
    ...
    <tr class="type-download">
        ...
        <td>
            ...
            <h1 class="title_text">Sơ yếu lý lịch</h1>
            <a name="<!--{$key}-->"></a>
            ...
            <!--{if $arrForm.cv != ""}-->
                ...
                <a href="" onclick="eccube.setModeAndSubmit('delete_down', '', ''); return false;">[Xóa tệp]</a><br />
            <!--{/if}-->
            ...
            <h1 class="title_text m-t-10">Lịch sử công việc</h1>
            <a name="<!--{$key2}-->"></a>
            ...
            <a href="" onclick="eccube.setModeAndSubmit('delete_down_resume', '', ''); return false;">[Xóa tệp]</a><br />
            <!--{/if}-->
