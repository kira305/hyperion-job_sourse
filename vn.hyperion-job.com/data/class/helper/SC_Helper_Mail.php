...
class SC_Helper_Mail
{
    ...
    public function sfSendTemplateMail($to, $to_name, $template_id, &$objPage, $from_address = '', $from_name = '', $reply_to = '', $bcc = '')
    {
        ...
        $objPage->tpl_header = $mailtemplate['header_vn'];
        $objPage->tpl_footer = $mailtemplate['footer_vn'];
        $tmp_subject = $mailtemplate['subject_vn'];
    ...
    public function sfSendOrderMail($order_id, $template_id, $subject = '', $header = '', $footer = '', $send = true)
    {
        ...
        if ($subject == '' && $header == '' && $footer == '') {
            ...
            $objMailtemplate = new SC_Helper_Mailtemplate_Ex();
            $mailtemplate = $objMailtemplate->get($template_id);
            $arrTplVar->tpl_header = $mailtemplate['header_vn'];
            $arrTplVar->tpl_footer = $mailtemplate['footer_vn'];
            $tmp_subject = $mailtemplate['subject_vn'];
        } else {
        ...
        $arrProduct = $objQuery->select('product_id, currency, salary_type, salary_min, salary_max, salary, working_day_vn, working_hour_vn, region, city, work_location_vn, name_vn, salary_vn', 'dtb_products', $where);
    ...
    public function sfMakeSubject($subject, &$objMailView = NULL)
    {
        ...
        $arrInfo = SC_Helper_DB_Ex::sfGetBasisData();
        $objTplAssign->tpl_shopname=$arrInfo['shop_name_eng'];
