...
class SC_CustomerList extends SC_SelectSql_Ex
{
    ...
    {
        $this->select = 'SELECT customer_id,name01,name02,kana01,kana02,sex,email,email_mobile,tel01,tel02,tel03,pref,status,update_date,mailmaga_flg,pref_by_text,tel,cv,cv_name,resume,resume_name FROM dtb_customer ';
